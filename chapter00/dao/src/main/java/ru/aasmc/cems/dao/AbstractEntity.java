package ru.aasmc.cems.dao;

import com.fasterxml.jackson.annotation.JsonFormat;
import org.springframework.format.annotation.DateTimeFormat;
import ru.aasmc.cems.util.DateProcessor;
...
public class AbstractEntity {
     ...
     * This identifier is mapped by ORM (Object Relational Mapper) to the
     * database primary key of the Person record to which
     ...
     * Is is used by persistence frameworks
