...
public class SecuredRestApplicationTest {
    ...
    void shouldUpdateAPerson() {
        Person person = buildPerson("sherlock.holmes",
                "Sherlock Cornelius",
                "Holmes",
                "complicated");
        ...
        ResponseEntity<Void> responseEntity = testRestTemplate.withBasicAuth("john", "doe")
                .exchange(baseUrl.concat("/1"), HttpMethod.PUT, putRequest, Void.class);
    ...
    void shouldCreateAPerson() {
        Person person = buildPerson("gigi.pedala",
                "Gigi",
                "Pedala",
                "1dooh2" );
